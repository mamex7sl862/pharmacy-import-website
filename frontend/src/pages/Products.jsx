...
// Static fallback — always visible even without a DB connection
const STATIC_PRODUCTS = [
  ...
  { id: 's2',  name: 'Atorvastatin 20mg',       genericName: 'Atorvastatin Calcium',      brand: 'Pfizer Inc.',     category: 'prescription',    packageSize: 'Pack of 30 Tablets',            imageUrl: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=600&q=80' },
  ...
  { id: 's4',  name: 'Aspirin Protect 100mg',   genericName: 'Acetylsalicylic Acid',      brand: 'Bayer AG',        category: 'otc',             packageSize: 'Box of 100 Tablets',            imageUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=600&q=80' },
  { id: 's5',  name: 'Nexium 40mg',             genericName: 'Esomeprazole Magnesium',    brand: 'AstraZeneca',     category: 'prescription',    packageSize: 'Box of 28 Gastro-Resistant Tabs', imageUrl: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&q=80' },
  { id: 's6',  name: 'Entresto 97/103mg',       genericName: 'Sacubitril/Valsartan',      brand: 'Novartis AG',     category: 'prescription',    packageSize: 'Box of 56 Tablets',             imageUrl: 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=600&q=80' },
  { id: 's7',  name: 'Surgical Gloves L',       genericName: 'Latex Examination Gloves',  brand: 'Ansell',          category: 'surgical',        packageSize: 'Box of 100 Pairs',              imageUrl: 'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=600&q=80' },
  { id: 's8',  name: 'Vitamin D3 1000IU',       genericName: 'Cholecalciferol',           brand: 'NutraCare',       category: 'personal-care',   packageSize: '90 Softgel Capsules',           imageUrl: 'https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=600&q=80' },
  { id: 's9',  name: 'Paracetamol 500mg',       genericName: 'Acetaminophen',             brand: 'Generic Pharma',  category: 'otc',             packageSize: 'Box of 100 Tablets',            imageUrl: 'https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?w=600&q=80' },
  { id: 's10', name: 'Metformin HCL 1000mg',    genericName: 'Metformin Hydrochloride',   brand: 'Bayer Healthcare',category: 'prescription',    packageSize: 'Box of 60 Tablets',             imageUrl: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=600&q=80' },
  { id: 's11', name: 'Lisinopril 10mg',         genericName: 'Lisinopril',                brand: 'Pfizer Inc.',     category: 'prescription',    packageSize: 'Bottle of 30 Tablets',          imageUrl: 'https://images.unsplash.com/photo-1576671081837-49000212a370?w=600&q=80' },
